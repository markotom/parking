        ...
        doc.save(function (err, saved) {
          ...
          if(saved.status == 'Aprobada') {
            var message = "<p>Estimado(a) " + saved.fullname.name + " " + saved.fullname.surname + ",</p>"
                        ...
                        + "estacionamiento. Ya puede recoger su tarjeta en la Secretaría Académica, de 11:00 a 14:00 hrs. y de 17:00 a 19:00 hrs. "
                        + "Para que le sea entregada, es necesario que presente copia o la "
